...
//Сборка проекта на Gulp 4_(ITDoctor).
...
gulp.task('libsCSS', function () {
    return gulp.src([
        ...
        'node_modules/jquery-form-styler/dist/jquery.formstyler.css', // Это стили jQuery плагина для стилизации селектов, чекбоксов, радиокнопок, файловых и числовых полей.
        // 'node_modules/jquery-form-styler/dist/jquery.formstyler.theme.css' // Это темы стилей jQuery плагина для стилизации селектов, чекбоксов, радиокнопок, файловых и числовых полей.
    ])
...
gulp.task('libsJS', function () {
    return gulp.src([
        ...
        // 'node_modules/wow.js/dist/wow.js', // Самостоятельная (не требует jQuery) JS библиотека для анимации элементов по мере прокрутки страницы.
        'node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js', // Это jQuery lightbox скрипт для отображения изображений, видео и другого контента.
        'node_modules/jquery-form-styler/dist/jquery.formstyler.js' // Это jQuery плагин для стилизации селектов, чекбоксов, радиокнопок, файловых и числовых полей.
    ])
...
const styleFiles = [
    './src/scss/main.scss', // Основной scss-код.
    // './src/scss/_media.scss' // Медиа-запросы должны быть подключены после основного scss-кода.
];
...
const scriptFiles = [
    './src/js/_libs.js', // Библиотеки должны быть подключены до основгого js-кода.
    './src/js/main.js' // Основной js-код.
];
